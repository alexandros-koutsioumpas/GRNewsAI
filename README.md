...
- Αλλάζοντας το `SUMMARY_MODEL` και `BROADCAST_MODEL` σε "ελαφρύτερο" μοντέλο (π.χ. Meltemi-Instruct) και ας μην είναι optimized στα ελληνικά ίσως κάνει τον κώδικα πολύ πιο γρήγορο σε σχετικά παλιά μηχανήματα. Βέβαια θα είναι αναμενώμενη η πτώση της ποιότητας του δελτίου (to be checked)..
